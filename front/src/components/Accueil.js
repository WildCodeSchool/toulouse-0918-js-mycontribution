      ...
      <div>
        <Container fluid>
          <Row className="d-flex justify-content-center my-5">
            <Col xs='12' sm='12' md='4' className='bienvenue rounded py-3' style={{ fontWeight: 'bold' }}>{this.state.connexion ? `Bonjour ${this.state.profil} !` : <div>Bienvenue sur<br />My Contribution</div>}</Col>
          </Row>
        </Container>
        {this.state.connexion ? '' :
          <Container fluid>
            <Row className="d-flex justify-content-center">
              <Col xs='12' sm='12' md='8' className='presentation rounded py-4 px-4'>
                <h5 style={{ fontWeight: 'bold' }}>Qu’est-ce que My Contribution ?</h5>
        ...
        <Container fluid>
          <Row className="d-flex justify-content-center my-5">
            <Col xs='12' sm='12' md='8' className='actualite rounded py-4 px-4'>
              <div>
                <h5 style={{ fontWeight: 'bold' }} className="fas fa-lightbulb"> Prochains évènements</h5>
                <hr />
              </div>
              <div>
        ...
        <Container fluid>
          <Row className="d-flex justify-content-center my-5">
            <Col xs='12' sm='12' md='8' className='chercher rounded py-4 px-4 text-center'>
              <h3 style={{ fontWeight: 'bold' }}>Vous cherchez :</h3>
        ...
        <Container fluid>
          <Row className="d-flex justify-content-center my-5">
            <Col xs='12' sm='12' md='8' className='proposer rounded py-4 px-4 text-center'>
              <h3 style={{ fontWeight: 'bold' }}>Vous voulez proposer : </h3>
              <Row className="d-flex justify-content-between my-4">
