      ...
      <div>
        <Container fluid>
          <Row className="d-flex justify-content-center my-5">
            <Col xs="9" sm="6" md="4" className="bienvenue rounded py-3" style={{ fontWeight: 'bold' }}>{this.state.connexion ? `Bonjour ${this.state.profil} !` : <div>Bienvenue sur<br />My Contribution</div>}</Col>
          </Row>
        </Container>
